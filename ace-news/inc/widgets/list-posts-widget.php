<?php
if ( ! class_exists( 'Ace_News_List_Posts_Widget' ) ) {
	/**
	 * Adds Ace_News_List_Posts_Widget Widget.
	 */
	class Ace_News_List_Posts_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$ace_news_list_posts_widget_ops = array(
				'classname'   => 'list-post ascendoor-widget style-1',
				'description' => __( 'Retrive List Posts Widgets', 'ace-news' ),
			);
			parent::__construct(
				'ace_news_list_posts_widget',
				__( 'Ascendoor List Posts Widget', 'ace-news' ),
				$ace_news_list_posts_widget_ops
			);
		}
