...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class Ace_News_Toggle_Switch_Custom_Control extends WP_Customize_Control {
		/**
	 ...
	 */
	class Ace_News_Customize_Horizontal_Line extends WP_Customize_Control {
		/**
		 * Control Type.
		 */
		public $type = 'hr';
...
if ( class_exists( 'WP_Customize_Section' ) ) {
	 ...
	 * Upsell section
	 */
	class Ace_News_Upsell_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'ace-news-upsell';
